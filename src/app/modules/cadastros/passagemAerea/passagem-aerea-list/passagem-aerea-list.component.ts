...
@Component({
    ...
    templateUrl: './passagem-aerea-list.component.html',
    styleUrls: ['./passagem-aerea-list.component.scss'],
    encapsulation: ViewEncapsulation.None,
})

export class PassagemAereaListComponent implements OnInit, OnDestroy {
    ...
    productsTableColumns: string[] = ['dataVoo', 'empresa', 'origem', 'destino', 'assento', 'nome', 'actions'];
    ...
    load() {
        this.isLoading = true;
        this._passagemAereaService.list(this.query).subscribe(result => {
            this.passagens = result.data;
    ...
    delete(id: string) {
        this.isLoading = true;
        this._passagemAereaService.delete(id).subscribe(_ => {
    ...
    openDialogExcel(): void {
        const dialogRef = this.dialog.open(PassagemAereaModalExcelComponent, {
          width: '500px',
        });
    ...
    openDialogPdf(): void {
        const dialogRef = this.dialog.open(PassagemAereaModalPdfComponent, {
          width: '500px',
        });
