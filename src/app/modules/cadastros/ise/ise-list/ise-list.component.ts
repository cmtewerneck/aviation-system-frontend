...
export class IseListComponent implements OnInit, OnDestroy {
    ...
    productsTableColumns: string[] = ['dataCriacao', 'responsavel', 'canac', 'dataEnvio', 'actions'];
    ...
    load() {
        this.isLoading = true;
        this._iseService.list(this.query).subscribe(result => {
            this.ises = result.data;
    ...
    delete(id: string) {
        this.isLoading = true;
        this._iseService.delete(id).subscribe(_ => {
