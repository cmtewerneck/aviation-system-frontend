...
export class InstrutorListComponent implements OnInit, OnDestroy {
    ...
    load() {
        this.isLoading = true;
        this._instrutorService.list(this.query).subscribe(result => {
    ...
    delete(id: string) {
        this.isLoading = true;
        this._instrutorService.delete(id).subscribe(_ => {
    ...
    exportToExcel() {
        this._instrutorService.exportToExcel(3).subscribe(res => {
            console.log(res);
        }, error => {
            console.log(error);
        });
    ...
    exportToPdf() {
        this._instrutorService.exportToPdf(3).subscribe(res => {
            console.log(res);
        }, error => {
            console.log(error);
        });
    ...
    openDialogDelete(id): void {
        const dialogRef = this.dialog.open(InstrutorModalExcluirComponent, {
          width: '500px',
          data: { id: id }
        });
