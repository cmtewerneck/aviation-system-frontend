...
@Component({
    selector: 'app-fip-list',
    templateUrl: './fip-list.component.html',
    styleUrls: ['./fip-list.component.scss'],
    encapsulation: ViewEncapsulation.None,
})

export class FipListComponent implements OnInit, OnDestroy {
    ...
    productsTableColumns: string[] = ['fase', 'licao', 'descricao', 'actions'];
    ...
    load() {
        this.isLoading = true;
        this._fipService.list(this.query).subscribe(result => {
            this.fips = result.data;
    ...
    delete(id: string) {
        this.isLoading = true;
        this._fipService.delete(id).subscribe(_ => {
    ...
    filter() {
        ...
        if (filter.fase?.trim()) {
            this.query.filters.push(new FilterInfo('fase', FieldTypeEnum.String, FilterOperatorEnum.Contains, filter.fase.trim()));
        }

        if (filter.licao?.trim()) {
            this.query.filters.push(new FilterInfo('licao', FieldTypeEnum.String, FilterOperatorEnum.Contains, filter.licao.trim()));
        }
