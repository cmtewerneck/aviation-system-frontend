...
@Component({
    ...
    styleUrls: ['./diario-bordo-list.component.scss'],
    encapsulation: ViewEncapsulation.None,
})

export class DiarioBordoListComponent implements OnInit, OnDestroy {
    ...
    productsTableColumns: string[] = ['data', 'numero', 'pagina', 'matricula', 'actions'];
    ...
    load() {
        this.isLoading = true;
        this._diarioBordoService.list(this.query).subscribe(result => {
            this.diarios = result.data;
    ...
    delete(id: string) {
        this.isLoading = true;
        this._diarioBordoService.delete(id).subscribe(_ => {
