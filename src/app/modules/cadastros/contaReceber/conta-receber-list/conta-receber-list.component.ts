...
export class ContaReceberListComponent implements OnInit, OnDestroy {
    ...
    productsTableColumns: string[] = ['descricao', 'valorReceber', 'valorRecebido', 'dataRecebimento', 'situacao', 'actions'];
    ...
    load() {
        this.isLoading = true;
        this._contaReceberService.list(this.query).subscribe(result => {
    ...
    delete(id: string) {
        this.isLoading = true;
        this._contaReceberService.delete(id).subscribe(_ => {
    ...
    exportToExcel() {
        this._contaReceberService.exportToExcel(1).subscribe(res => {
            console.log(res);
        }, error => {
            console.log(error);
        });
    ...
    exportToPdf() {
        this._contaReceberService.exportToPdf(1).subscribe(res => {
            console.log(res);
        }, error => {
            console.log(error);
        });
