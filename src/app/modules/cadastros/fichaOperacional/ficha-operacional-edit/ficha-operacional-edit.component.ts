...
@Component({
    selector: 'app-ficha-operacional-edit',
    templateUrl: './ficha-operacional-edit.component.html',
    styleUrls: ['./ficha-operacional-edit.component.scss'],
    encapsulation: ViewEncapsulation.None,
})

export class FichaOperacionalEditComponent implements OnInit, OnDestroy {
    ...
    save() {
        ...
        const $obs = this.id ? this._fichaOperacionalService.update(model) : this._fichaOperacionalService.insert(model);
    ...
    loadEntity() {
        this.isLoading = true;
        this._fichaOperacionalService.getById(this.id).subscribe(model => {
