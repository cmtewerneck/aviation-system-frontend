...
@Component({
    selector: 'app-categoria-treinamento-edit',
    templateUrl: './categoria-treinamento-edit.component.html',
    styleUrls: ['./categoria-treinamento-edit.component.scss'],
    encapsulation: ViewEncapsulation.None,
})

export class CategoriaTreinamentoEditComponent implements OnInit, OnDestroy {
    ...
    save() {
        ...
        const $obs = this.id ? this._categoriaTreinamentoService.update(model) : this._categoriaTreinamentoService.insert(model);
    ...
    loadEntity() {
        this.isLoading = true;
        this._categoriaTreinamentoService.getById(this.id).subscribe(model => {
